...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *AdvisorResourcePath) DeepCopyInto(out *AdvisorResourcePath) {
	*out = *in
	out.Advisor = in.Advisor
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AdvisorResourcePath.
func (in *AdvisorResourcePath) DeepCopy() *AdvisorResourcePath {
	if in == nil {
		return nil
	}
	out := new(AdvisorResourcePath)
	in.DeepCopyInto(out)
	return out
}
